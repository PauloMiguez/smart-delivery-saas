    ...
    return (
        <AdminContainer>
            ...
            <MainContent>
                ...
                {/* PRODUTOS - COM MESMO LAYOUT DOS PEDIDOS */}
                {/* PRODUTOS - CORRIGIDO (SEM TÍTULO DUPLICADO) */}
{activeTab === 'products' && (
    <ProductsContainer>
        <ProductFilters 
...
{/* CATEGORIAS - CORRIGIDO (SEM TÍTULO DUPLICADO) */}
...
{/* PEDIDOS - CORRIGIDO (SEM TÍTULO DUPLICADO) */}
{activeTab === 'orders' && (
    <OrdersContainer>
        {orders.length === 0 ? (
